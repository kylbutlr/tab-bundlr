...
Organize browser tabs into predictable workspaces using transparent URL rules.

## Detailed description

Tab Bundlr turns open browser tabs into predictable, user-controlled workspaces.
...
Tab Bundlr organizes browser tabs into user-defined Chrome tab-group workspaces.

## Permission explanations

**Storage:** Saves local workspace rules, preferences, and temporary session state.

**Tabs:** Reads URLs and titles for transparent rule matching and performs visible grouping, activation, review, and user-confirmed closure actions.
...
No selling or sharing of user data. No analytics or advertising. No Tab Bundlr backend. Workspace Source credentials remain in extension-local storage and are excluded from backups.

## Publication status

Draft only. Do not submit without explicit approval and final store-policy review.
